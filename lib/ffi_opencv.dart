...
import 'ffi_opencv_bindings_generated.dart';

int sum(int a, int b) => _bindings.sum(a, b);

String helloFromFd() => _bindings.sayHelloFromFd().toDartString();

String getMajorVersion() => _bindings.getMajorVersion().toDartString();
    ...
    final ReceivePort helperReceivePort = ReceivePort()
      ..listen((dynamic data) {
        ...
        if (data is _SumRequest) {
          final int result = _bindings.sumLongRunning(data.a, data.b);
